...
CALLSIGNS = [
    "Яструб", "Вовк", "Фенікс", "Тінь", "Гром", "Кобра", "Сокіл", "Лев",
    "Орел", "Тигр", "Змій", "Барс", "Рись", "Шторм", "Блискавка", "Пантера",
    "Крук", "Скорпіон", "Ведмідь", "Ворон", "Лис", "Пума", "Ягуар", "Гепард",
    "Сова", "Беркут", "Козак", "Сніг", "Вітер", "Полум'я", "Стріла", "Меч",
    "Щит", "Зірка", "Хвиля", "Клинок", "Дракон", "Саламандра", "Грифон", "Фалкон"
]
rooms = {}
last_save_time = 0
SAVE_INTERVAL = 5
